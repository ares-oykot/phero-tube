...
const buttonActive = (id) => {
    ...
    const btnComedy = document.getElementById('comedy')
    const btnDrawing = document.getElementById('drawing')
    if(id == 1000){
        btnAll.style.backgroundColor = "#ff5f53"
        btnMusic.style.backgroundColor = "#CBD5E1"
        btnComedy.style.backgroundColor = "#CBD5E1"
        btnDrawing.style.backgroundColor = "#CBD5E1"
    }
    else if(id == 1001){
        btnAll.style.backgroundColor = "#CBD5E1"
        btnMusic.style.backgroundColor = "#ff5f53"
        btnComedy.style.backgroundColor = "#CBD5E1"
        btnDrawing.style.backgroundColor = "#CBD5E1"
    }
    else if(id == 1003){
        btnAll.style.backgroundColor = "#CBD5E1"
        btnMusic.style.backgroundColor = "#CBD5E1"
        btnComedy.style.backgroundColor = "#ff5f53"
        btnDrawing.style.backgroundColor = "#CBD5E1"
    }
    else if(id == 1005){
        btnAll.style.backgroundColor = "#CBD5E1"
        btnMusic.style.backgroundColor = "#CBD5E1"
        btnComedy.style.backgroundColor = "#CBD5E1"
        btnDrawing.style.backgroundColor = "#ff5f53"
    }
    else{
        btnAll.style.backgroundColor = "#CBD5E1"
        btnMusic.style.backgroundColor = "#CBD5E1"
